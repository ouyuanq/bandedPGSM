...
function GSBSPG_Chebyshev_NI(::Type{T}, lincoeffs::Vector{Vector{T}}, K::BandedMatrix{T}, bc::AbstractVector{T}, fc::AbstractVector{T}) where {T}
    ...
    # get values of basis of test space on Gauss-Chebyshev points (a window of L.l + L.u + 1 bases at the same time)
    xTest = Vector{Vector{T}}(undef, L.l + L.u + 1)
